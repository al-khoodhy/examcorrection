...
@section('page_header')
    <div class="container-fluid">
        ...
        <a href="http://localhost/examcorrection/public/app/assessment/add" class="btn btn-success btn-add-new">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <a href="http://localhost/examcorrection/public/app/assessments/view/{{ $item->slug }}" style="color: black">
                        <div class="col-lg-12">
                                <div class="row">
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div style="background-color: rgb(143, 199, 155); margin-left:42px; margin-top:2px; padding:3px">{{ $item->classroom }}</div>
                                                        </div>
                                                    </div>
                                                  </div>
                                                </div>
